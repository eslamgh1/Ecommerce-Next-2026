...
// we use async function to make the order
    async function makeCashOrder() {
        ...
        try {
            ...
            const isSuccess = await createCashOrder(cartId, address)
            console.log("Order created successfully:", isSuccess)
            if(isSuccess){
...
// we use async function to make the order
    async function makeCardOrder() {
        ...
        try {
            // call Api // server action
            const isSuccess = await makeCheckoutSession(cartId, address)
            console.log("Checkout session created successfully:", isSuccess)
            if(isSuccess){
